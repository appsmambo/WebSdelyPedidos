...
`id` int(10) unsigned NOT NULL,
  ...
  `dni` varchar(11) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Dni o Ruc',
...
`id` int(11) NOT NULL,
  ...
  `dni` varchar(11) COLLATE utf8_spanish2_ci NOT NULL COMMENT 'Dni o Ruc',
  `telefono` varchar(20) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `direccion` varchar(50) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `ubigeo` int(11) DEFAULT NULL,
  `tipo` tinyint(4) NOT NULL COMMENT '1:Administrador | 2:Centro Distribucion',
  `email` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `login` varchar(50) COLLATE utf8_spanish2_ci NOT NULL COMMENT 'Sirve para definir el centro de distribución',
